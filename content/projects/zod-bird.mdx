...
repository: filipaoliveira/zod-bird
date: "2023-05-21"
published: true
---
...
```ts
import { Tinybird } from "@filipaoliveira/zod-bird";
import { z } from "zod";
...
const res = await getEvents({ tenantId: "filipaoliveira" });
